...
Note: This is probably isn't the optimal way to work non-JAX likelihood functions into NumPyro. It definitely takes a hit in performance. But it works for now.
